...
digit_expression :	
    digit_expression (MULTIPLY|DIVIDE) digit_expression
...
program_call        : (ID (input_signature|(O_BRACKET C_BRACKET)));
...
get_mat_row_by_id   : (ID O_SQUARE_BRACKET digit_expression C_SQUARE_BRACKET) ;
